...
public class News 
{
    public static Node getContent(HostServices host) {
        ...
        Font welcomeFont = Font.font("Bauhaus 93", FontWeight.BOLD, 60);
        Font footnoteFont = Font.font("Palatino Linotype", FontWeight.BOLD, 14);

        VBox topSection = createStyledTextSection(Info.NEWS_TEXT, TEXT_WRAP_WIDTH, welcomeFont, null);
        topSection.setAlignment(Pos.CENTER);

        VBox middleSection = new VBox();
        middleSection.getChildren().add(
            createBodyLeft("/resources/news1.png", Info.NEWS_TEXT_ONE, IMAGE_WIDTH, IMAGE_HEIGHT, TEXT_WRAP_WIDTH, host, "https://mailchi.mp/yale.edu/news-from-new-haven-8034100")
        );
        middleSection.getChildren().add(
            createBodyRight("/resources/news2.png", Info.NEWS_TEXT_TWO, IMAGE_WIDTH, IMAGE_HEIGHT, TEXT_WRAP_WIDTH, host, "https://mailchi.mp/yale.edu/news-from-new-haven-8034064")
        );

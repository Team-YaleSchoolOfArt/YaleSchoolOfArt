...
public class AboutUs 
{
    public static Node getContent() {
        ...
        VBox topSection = createStyledTextSection(Info.ABOUT_TEXT, TEXT_WRAP_WIDTH, welcomeFont, null);
        topSection.setAlignment(Pos.CENTER);

        VBox middleSection = new VBox();
        middleSection.getChildren().add(
            createBodyLeft("/resources/about1.jpg", Info.ABOUT_TEXT_ONE, IMAGE_WIDTH, IMAGE_HEIGHT, TEXT_WRAP_WIDTH)
        );
        middleSection.getChildren().add(
            createBodyRight("/resources/about2.jpg", Info.ABOUT_TEXT_TWO, IMAGE_WIDTH, IMAGE_HEIGHT, TEXT_WRAP_WIDTH)
        );
